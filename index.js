...
case'help':
await reply(`Ind : Hai ${pushname}, untuk menemukan semua perintah silahkan ketik ${prefix}menu

Bule Gajelas : Hi ${pushname}, to find all commands please type ${prefix}menu`)
break
